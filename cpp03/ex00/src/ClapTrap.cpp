...
/*   Updated: 2026/05/18 19:40:50 by fiheaton         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name){
	...
	this->_ep = 10;
	this->_dmg = 0;
	std::cout << "Constructor called for ClapTrap named: " << this->_name << std::endl << std::endl;
}

ClapTrap::~ClapTrap(){
	std::cout << "Destructor called for ClapTrap named:" << this->_name << std::endl << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount){
	this->_hp -= amount;
	std::cout << "ClapTrap \""<< this->_name << "\" takes " << amount << " points of damage, he has " << this->_hp << " health left" << std::endl;
}
